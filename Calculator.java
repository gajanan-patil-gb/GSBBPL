...
class GSBCalculator extends WindowAdapter implements ActionListener
{
    ...
    public GSBCalculator(int width, int height, String title)
    {
...
class Calculator
{
    ...
    {
        GSBCalculator cobj = new GSBCalculator(400,400,"##..GSB'S_CALCULATOR..##");
    }
}